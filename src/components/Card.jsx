...
export default function Card({movieData , isLiked = false}) {
  ...
  const [isHovered,setiIsHovered] = useState(false);
  const navigate = useNavigate();

  return (
    <Container onMouseEnter={() => setiIsHovered(true)} onMouseLeave={()=> setiIsHovered(false)}>
      ...
      isHovered && (
        <div className="hover">
          ...
          <div className="info-container flex column">
            <h3 className='name' onClick={()=>("/player")}>{movieData.name}</h3>
